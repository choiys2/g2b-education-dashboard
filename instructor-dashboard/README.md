...
## 데이터 갱신 이력
- 2026-09-22: "26년 인공지능연수(3권역)" 최종 강사풀 설문(118명, 구글폼 응답)을 강사 DB(`dataBlob`)에 병합. 116명은 기존 레코드에 프로필(직위·경력·선도교사 유형·대표 이력) 추가, 2명(이승동·권재철)은 "신규 후보" 등급으로 신규 등록. 상세는 대시보드 내 "데이터 노트" 탭 [2026-09-22 갱신] 항목 참고.
